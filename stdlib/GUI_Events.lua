...
-- Registers a callback function to be called on_gui_value_changed event
function GUI_Events.register_on_gui_value_changed(el_name, callback)
    GUI_Events.register(el_name, callback, true, "on_gui_value_changed")
end
