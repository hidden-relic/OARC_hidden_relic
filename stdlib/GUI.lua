...
-- Adds a slider to the parent element
-- @tparam LuaGuiElement parent Element
-- @param el_definition element definition
-- @param callback function
-- @treturn LuaGuiElement el
function GUI.add_slider(parent, el_definition, callback)
    GUI.fail_on_type_mismatch(el_definition, "slider")
    ...
    GUI.register_if_callback(
        callback,
        el_definition.name,
        GUI_Events.register_on_gui_value_changed
    )
